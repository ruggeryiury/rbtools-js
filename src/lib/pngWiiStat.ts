 ...
 */
export const pngWiiStat = async (filePath: Path | string): Promise<TextureFileStatReturnObject> => {
  let srcPath: Path
 ...
 */
export const pngWiiStatSync = (filePath: Path | string): TextureFileStatReturnObject => {
  let srcPath: Path
