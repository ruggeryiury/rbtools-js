 ...
 * @param {FilePathLikeTypes} destPath The path to the new converted DDS file.
 ...
 */
export const NVCompress = async (srcFile: FilePathLikeTypes, destPath: FilePathLikeTypes, DTX5 = true, mipMap = true): Promise<string> => {
