 ...
 */
export const texToTex = async (srcFile: FilePathLikeTypes, destPath: FilePathLikeTypes, toFormat: ArtworkTextureFormatTypes, options?: ConvertTextureToTextureOptions): Promise<TextureFile> => {
