...
export const createDTA = (songdata: SongDataCreationObject): DTAFile => {
  ...
  map.set('bank', getKeyFromMapValue(dtaLocale.percussionBank, bank))
  map.set('drum_bank', getKeyFromMapValue(dtaLocale.drumBank, drumBank))
  map.set('anim_tempo', Number(getKeyFromMapValue(dtaLocale.animTempo, animTempo)))
  map.set('band_fail_cue', getKeyFromMapValue(dtaLocale.bandFailCue, bandFailCue))
  map.set('song_scroll_speed', Number(getKeyFromMapValue(dtaLocale.songScrollSpeed, songScrollSpeed)))
  ...
  map.set('game_origin', getKeyFromMapValue(dtaLocale.gameOrigin, gameOrigin))
  map.set(
    'encoding',
    ((): SongEncoding => {
  ...
  map.set('rating', Number(getKeyFromMapValue(dtaLocale.rating, rating)))

  map.set('genre', getKeyFromMapValue(dtaLocale.genre, g))
  map.set('sub_genre', getKeyFromMapValue(dtaLocale.subGenre, subGenre))
