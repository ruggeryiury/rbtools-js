...
export interface DTAFile {
  ...
  /**
   * Tells the type of the song's audio stems. It can be `true`, representing `multitrack`.
   */
  multitrack?: 'diy_stems' | 'partial' | 'karaoke' | 'multitrack' | null
  /**
   * Tells if the song has unpitched vocals.
   */
  unpitched_vocals?: boolean
  /**
